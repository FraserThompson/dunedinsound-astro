...
<Image2 responsiveImage={frontmatter.responsiveImages["spaceland"]} alt="'Spaceland'"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["opening_gig"]} alt="'The opening gig'"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["spaceland_market"]} alt="'Spaceland market.'"/>
