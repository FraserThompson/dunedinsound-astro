...
description: '"We are not able to afford the ‘4 toilets’ he quoted to make our
  building compliant"'
tags:
  - Opinion
  - Venues
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['spaceland']} alt="'Spaceland'"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['opening_gig']} alt="'The opening gig'"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['spaceland_market']} alt="'Spaceland market.'"/>
