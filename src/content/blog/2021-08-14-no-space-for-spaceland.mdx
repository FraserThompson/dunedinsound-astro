...
<Image images={frontmatter.responsiveImages} src="spaceland" alt="'Spaceland'"/>
...
<Image images={frontmatter.responsiveImages} src="opening_gig" alt="'The opening gig'"/>
...
<Image images={frontmatter.responsiveImages} src="spaceland_market" alt="'Spaceland market.'"/>
