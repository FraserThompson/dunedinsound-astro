...
<Image responsiveImage={frontmatter.responsiveImages['spaceland']} alt="'Spaceland'"/>
...
<Image responsiveImage={frontmatter.responsiveImages['opening_gig']} alt="'The opening gig'"/>
...
<Image responsiveImage={frontmatter.responsiveImages['spaceland_market']} alt="'Spaceland market.'"/>
