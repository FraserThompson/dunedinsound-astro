...
description: For many joining a virtual "crowd" on Facebook or Zoom seems
  strange and antithetical, but it’s not a new concept.
tags:
  - Opinion
---
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['band']} alt="Virtual pint night 1/4/20 via Zoom"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['oster']} alt="SPF420 27/3/2020 Poster"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['pf420']} alt="SPF420 27/3/2020: Et Aliae"/>
