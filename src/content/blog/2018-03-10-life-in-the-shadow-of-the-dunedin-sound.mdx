...
<Image responsiveImage={frontmatter.responsiveImages['before_after']} alt="Before and after Coyote"/>
_before and after coyote_

<Image responsiveImage={frontmatter.responsiveImages['coyote_comments_1']} alt="Baying for heretic blood"/>
...
<Image responsiveImage={frontmatter.responsiveImages['coyote_comments_3']} alt="Crude insults"/>
_Crude insults_

<Image responsiveImage={frontmatter.responsiveImages['coyote_comments_2']} alt="They literally are"/>
...
<Image responsiveImage={frontmatter.responsiveImages['edmural']} alt="$8,350 Mural"/>
_$8,350 Mural_

<Image responsiveImage={frontmatter.responsiveImages['coyote_graffiti_1']} alt="$8,351 Mural"/>
_$8,351 Mural_

On March 31st another piece of street art was vandalized with the words "Ed is ded long live coyote 🤘 666".

<Image responsiveImage={frontmatter.responsiveImages['coyote_graffiti_2']} alt="Vandalism"/>
_Vandalism_
