...
description: On Tuesday the 27th of February 2018 two masked terrorists
  committed a heinous act of vandalism.
relatedArtists:
  - coyote
  - the_chills
tags:
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['before_after']} alt="Before and after Coyote"/>
_before and after coyote_

<Image size="blog" responsiveImage={frontmatter.responsiveImages['coyote_comments_1']} alt="Baying for heretic blood"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['coyote_comments_3']} alt="Crude insults"/>
_Crude insults_

<Image size="blog" responsiveImage={frontmatter.responsiveImages['coyote_comments_2']} alt="They literally are"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['edmural']} alt="$8,350 Mural"/>
_$8,350 Mural_

<Image size="blog" responsiveImage={frontmatter.responsiveImages['coyote_graffiti_1']} alt="$8,351 Mural"/>
_$8,351 Mural_

On March 31st another piece of street art was vandalized with the words "Ed is ded long live coyote 🤘 666".

<Image size="blog" responsiveImage={frontmatter.responsiveImages['coyote_graffiti_2']} alt="Vandalism"/>
_Vandalism_
