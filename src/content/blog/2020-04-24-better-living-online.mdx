...
description: After a few weeks of figuring out the new normal, last weekend
  demonstrated that the local live music scene is anything but dead. It’s just
  different now, like pretty much everything else.
relatedGigs:
  - 2020-4-17-better-living-everyone-friday
tags:
  - Review
---
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['P1650437_DxO']} alt="Mousey"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['P1650454_DxO']} alt="Oscar Mein"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['P1650493_DxO']} alt="Ryan Fisherman"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['P1650642_DxO']} alt="Lawrence Arabia"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['P1650689_DxO']} alt="Hot in the City"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['oneworld1']} alt="Paul Mcartney sings Lady Madonna"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['oneworld2']} alt="Some doctors do the safety dance (?)"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['poster']} alt="Better living everyone setlist"/>
