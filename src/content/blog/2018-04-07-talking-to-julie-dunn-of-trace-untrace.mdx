...
description: In the first of a video series on cool people doing cool things I
  spoke to Julie Dunn who runs trace/untrace, a local micro-independent record
  label, to get the lowdown on the sort of operation she's running.
relatedArtists:
  - asta_rangu
  - koizilla
  - the_rothmans
