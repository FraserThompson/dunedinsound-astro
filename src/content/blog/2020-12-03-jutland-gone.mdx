...
description: Jutland Street - another doomed space which joins None Gallery, The
  Attic, and many more in the Dunedin cemetery for dead creative spaces.
relatedGigs:
  - 2020-12-5-jutland-st-last
relatedVenues:
  - jutland_street
tags:
  - Interview
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['street']} alt=""/>

<Image size="blog" responsiveImage={frontmatter.responsiveImages['crowd']} alt=""/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['wolfskull_1']} alt="Wolfskull"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['crude']} alt="Crude"/>

<Image size="blog" responsiveImage={frontmatter.responsiveImages['monolith']} alt="Monolith"/>

Some of the bands who played at Jutland included local staples of the experimental or noise scene like Alastair Galbraith, Eye, Wolfskull, Crude, and The Futurians. More recently it started hosting ticketed international acts through Audio Foundation but this led to some problems with the council and since then it’s been strictly local bands.
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['the_futurians']} alt="The Futurians"/>
