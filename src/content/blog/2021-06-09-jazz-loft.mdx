...
description: If there’s one thing I think we can all agree on here in the
  Ōtepoti music community, it’s that we’d quite like more spaces to perform and
  experience music in, which is why it pleases me greatly to see a new
  initiative intent on giving us exactly that.
relatedVenues:
  - albany_street_jazz_loft
tags:
  - Interview
  - Venues
---
