...
description: Finally, the crossover we've all been waiting for - student radio
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['stupid-meme']} alt="had to be done"/>
