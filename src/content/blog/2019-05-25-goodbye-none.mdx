...
<Image2 responsiveImage={frontmatter.responsiveImages["dont_define_none_processed"]} alt="Don't define None (From the archives. Photo by Oscar Francis)"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["from-kingdom-to-crown"]} alt="From Kingdom to Crown (2017)"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["realestatelisting"]} alt="Realestate listing"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["heritage_fund"]} alt="Heritage funding for a non-heritage building?"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["posters"]} alt="Posters of gigs over the years"/>

<Image2 responsiveImage={frontmatter.responsiveImages["old_bayleys_sale"]} alt="Previous sales listing"/>

<Image2 responsiveImage={frontmatter.responsiveImages["previous_sale_bayleys"]} alt="Parasites bragging about being parasites"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["rent_agreement_processed"]} alt="Rent agreement 2008 (From the archives. Photo by Oscar Francis.)"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["defining_none_processed"]} alt="Defining None (From the archives. Photo by Oscar Francis)"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["hallway"]} alt="Hallway from front gallery space to kitchen in rear"/>

<Image2 responsiveImage={frontmatter.responsiveImages["kitchen"]} alt="Kitchen"/>

<Image2 responsiveImage={frontmatter.responsiveImages["cupboard"]} alt="One of many storage rooms"/>

<Image2 responsiveImage={frontmatter.responsiveImages["elevator"]} alt="Inside the elevator"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["interview_processed"]} alt="Interview with Edwina Stevens from 2010 (Photo by Oscar Francis)"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["ladder-pit-1"]} alt="Motoko performing at None in 2017 with The Ladder is Part of the Pit"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["stairs_to_first_floor"]} alt="Stairs from second to first floor (previously lined with gig posters)"/>

<Image2 responsiveImage={frontmatter.responsiveImages["basement_stairs"]} alt="Stairs to basement"/>

<Image2 responsiveImage={frontmatter.responsiveImages["basement"]} alt="Basement"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["ladder-pit-2"]} alt="William Henry Meung performing at None in 2017 with The Ladder is Part of the Pit"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["P1110603"]} alt="Danny Brady performing at None in 2017 with Death and the Maiden"/>
...
<Image2 responsiveImage={frontmatter.responsiveImages["P1100786"]} alt="Christian McNab performing at None in 2017 as Acid Police"/>
