...
When I first designed the website, I was more motivated by what other sites did and what was "standard" web design. So I did the usual mobile first web UX where everything is big, and most effort is put into the mobile experience. This makes sense because mobile users are the majority. However, I've since realised it's overly simplistic to just look at minority/majority.
