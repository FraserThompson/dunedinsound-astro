...
<Image responsiveImage={frontmatter.responsiveImages['oldlayout1']} alt="Old Layout 1"/>
_Layout for a gig page on April 20, 2017. Imagine the images are there._

<Image responsiveImage={frontmatter.responsiveImages['oldlayout2']} alt="Old Layout 2"/>
...
<Image responsiveImage={frontmatter.responsiveImages['files2']} alt="Files 2"/>
...
<Image responsiveImage={frontmatter.responsiveImages['files']} alt="Files"/>
