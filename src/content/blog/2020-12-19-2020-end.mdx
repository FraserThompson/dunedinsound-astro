...
description: Did that just happen? It felt like one minute we were expulsing
  bodily fluids all over each other with wanton abandon, and the next we were
  avoiding the chip aisle until it was clear enough to maintain two metres of
  social distance.
tags:
  - Year in Review
---
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['betterliving']} alt="Christchurch festival 'Better Living Everyone' became a series of regular streamed gigs"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['princesschelsea']} alt="Princess Chelsea"/>
...
<Image size="blog" responsiveImage={frontmatter.responsiveImages['snc']} alt="Same Name Confusion"/>
