...
- Custom binaural headset: Two electret microphones, modified to withstand higher volumes without distorting, shoved into a pair of earplugs, and wired up to a battery box. They go in my ears and record sound with the added benefit of protecting my hearing somewhat. This is how I get decent sounding recordings without setting anything up or talking to the sound person. You can read more about this setup [here](/blog/so_you_want_to_bootleg_live_music_with_a_wearable_and_discreet_recording_rig_which_also_doubles_as_hearing_protection_and_doesnt_cost_that_much/).
...
* Photo: RAW files > DXO PhotoLab (denoising, contrast, and colour adjustment) > JPG
* Video: 4K H264 files (LOG) > Magix Vegas (colour grading, trimming) > 4K H265 for YouTube
* Audio: 44.1khz 24-bit WAV > Magix Vegas (limiting, compression, EQ) > 44.1khz 16-bit MP3 VBR V0
