...
- Custom binaural headset: Electret microphones modified to withstand higher volumes and shoved into a pair of earplugs. They go in my ears and record sound with the added benefit of protecting my hearing somewhat. This is how I get decent recordings without setting anything up. You can read more about this setup [here](/blog/so_you_want_to_bootleg_live_music_with_a_wearable_and_discreet_recording_rig_which_also_doubles_as_hearing_protection_and_doesnt_cost_that_much/)
- Panasonic S5 camera with an assortment of (semi) pocketable lenses, often vintage M42 mount lenses (Asahi Pentax 50mm 1.4 is my favourite). (I wrote a blog post about this camera [here](/blog/micro_four_thirds_vs_full_frame_bigger_more_expensive_but_is_it_better))
- Panasonic G85 as a b-cam for multi-angle video
- As of 2024 Zoom H1 Essential portable recorder. (Previously Roland R-05 but it started having issues)
...
* Photo: 24MP RAW files > DXO PhotoLab (denoising, contrast, and colour adjustment) > JPG > WebP responsive proxies and MozJPEG compressed original
