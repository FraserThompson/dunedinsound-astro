...
<div style={{ position: 'absolute', padding: 0, top: 0, left: 0, maxWidth: '100%', width: '100%' }}>
  <WebsiteInfo/>
</div>
...
The current cost of hosting everything is around ~~**\$10**~~ **\$2** a month (moving from S3 to Cloudflare's R2 drastically reduced costs). I will continue paying this for as long as I can.
...
If you're interested in subscribing to get notifications when gigs are posted you can find out how [here](/page/subscribe).
...
You can read more about this setup [here](/blog/so_you_want_to_bootleg_live_music_with_a_wearable_and_discreet_recording_rig_which_also_doubles_as_hearing_protection_and_doesnt_cost_that_much/) and [here](/blog/upgrading_my_wearable_binaural_recording_rig_guide/).
...
Nothing on dunedinsound.com has been modified or created via generative AI.
...
Also if you want content featuring you removed from the website for any reason feel free to contact me. I am not here to make anyone uncomfortable and that's more important than any overarching purpose. I can also blur/remove faces if necessary.
